    ...
    if current_status_message != None:
        ...
        if question.upper() == "N":
            ...
            if len(new_status_message) > 0:
                ...
                print('Your updated status message: %s' % updated_status_message)
            else:
                print("You did not provided any status message. Please try again.")
        ...
        # when user has diffrent choice than yes and no
            ...
            print('Invalid option choosen! Press either y or n.')
